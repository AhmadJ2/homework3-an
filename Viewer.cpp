...
namespace glfw
{
      ...
      const std::string & mesh_file_name_string)
  {
    ...
    //end comment Ass1
    //Ass3
    bool iszcylinder = mesh_file_name_string == "C:/Dev/EngineForAnimationCourse/tutorial/data/zcylinder.obj";
  ...
  IGL_INLINE void Viewer::open_dialog_load_mesh()
  {
    ...
    this->load_mesh_from_file("C:/Dev/EngineForAnimationCourse/tutorial/data/zcylinder.obj");
    data().show_texture = 2;
  ...
  void Viewer::FabrikAlgo() {
      ...
      if (dist > sumOf_di) {
          ...
          if (delta > difA) {
              isActive = false;
              printf("Remaining distance is: %f\n" , difA);
              axisFixer();
          }
      }
  }
