...
public:
	...
	//Ass 2 comment
	void changeMovingDirection(int dir);
	void changeRotateAxis(int rotate, bool picked);
	//changing moving direction of object according to direction vector and initial velocity
	//end comment Ass 2
